...
//        MinHash minhash = new MinHash(50, n);
//
//
//        boolean[] vector1 = new boolean[n];
//        for (int i = 0; i < n; i++) {
//            vector1[i] = Math.random() < 0.05;
//        }
//        int[] sig1 = minhash.signature(vector1);
//
//
//        boolean[] vector2 = new boolean[n];
//        for (int i = 0; i < n; i++) {
//            vector2[i] = Math.random() < 0.02;
//        }
...
//                MinHash.JaccardIndex(MinHash.Convert2Set(vector1), MinHash.Convert2Set(vector2)));
//    }
