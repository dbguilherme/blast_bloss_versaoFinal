...
public class RedefinedWeightedNodePruning extends MetaBlocking.EnhancedMetaBlocking.RedefinedWeightedNodePruning{
    ...
    public RedefinedWeightedNodePruning(AbstractDuplicatePropagation adp, String description, WeightingScheme scheme) {
